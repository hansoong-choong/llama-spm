...
int run_text_encoding(int argc, char ** argv, const void *swift_object, bool(*swift_callback)(const void *, const float *, int length)) {
    gpt_params params;
    ...
    if (n_prompts == 1) {
            swift_callback(swift_object, emb, n_embd);
        } else {
            swift_callback(NULL, NULL, 0);
    }
