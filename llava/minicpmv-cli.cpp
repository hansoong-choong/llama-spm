...
int run_minicpm(int argc, char ** argv, const void *swift_object, bool(*swift_callback)(const void *, const char*)) {
    ggml_time_init();
    ...
    for (auto & image : params.image) {
        ...
        if (!params.prompt.empty()) {
            ...
            for (int i = 0; i < max_tgt_len; i++) {
                ...
                swift_callback(swift_object, response.c_str());
                fflush(stdout);
            }
        ...
        //ctx_llava->model = NULL; //hansoong-disable
